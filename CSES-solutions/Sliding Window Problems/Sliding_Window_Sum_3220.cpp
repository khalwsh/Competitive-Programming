...
You are given an array of nnn integers. Your task is to calculate the sum of each window of kkk elements, from left to right.
...
Explanation: The input array is [3,0,1,8,2,4,7,6][3,0,1,8,2,4,7,6][3,0,1,8,2,4,7,6]. The windows are [3,0,1,8,2][3,0,1,8,2][3,0,1,8,2], [0,1,8,2,4][0,1,8,2,4][0,1,8,2,4], [1,8,2,4,7][1,8,2,4,7][1,8,2,4,7] and [8,2,4,7,6][8,2,4,7,6][8,2,4,7,6], and their sums are 141414, 151515, 222222 and 272727. Thus, the answer is 14⊕15⊕22⊕27=1214 \oplus 15 \oplus 22 \oplus 27 = 1214⊕15⊕22⊕27=12.
*/
#include <bits/stdc++.h>
using namespace std;
