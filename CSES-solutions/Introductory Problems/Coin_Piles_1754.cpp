...
You have two coin piles containing aaa and bbb coins. On each move, you can either remove one coin from the left pile and two coins from the right pile, or two coins from the left pile and one coin from the right pile.
Your task is to efficiently find out if you can empty both the piles.
Input
The first input line has an integer ttt: the number of tests.
After this, there are ttt lines, each of which has two integers aaa and bbb: the numbers of coins in the piles.
Output
For each test, print "YES" if you can empty the piles and "NO" otherwise.
Constraints

1≤t≤1051 \le t \le 10^51≤t≤105
0≤a,b≤1090 \le a, b \le 10^90≤a,b≤109
