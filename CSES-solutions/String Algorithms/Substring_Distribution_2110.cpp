...
You are given a string of length nnn. For every integer between 1…n1 \ldots n1…n you need to print the number of distinct substrings of that length.
Input
The only input line has a string of length nnn that consists of characters a–z.
Output
For each integer between 1…n1 \ldots n1…n print the number of distinct substrings of that length.
Constraints
