...
Consider a money system consisting of nnn coins. Each coin has a positive integer value. Your task is to calculate the number of distinct ways you can produce a money sum xxx using the available coins.
For example, if the coins are {2,3,5}\{2,3,5\}{2,3,5} and the desired sum is 999, there are 888 ways:
