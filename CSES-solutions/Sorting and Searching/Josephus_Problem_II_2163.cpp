...
Consider a game where there are nnn children (numbered 1,2,…,n1,2,\dots,n1,2,…,n) in a circle. During the game, repeatedly kkk children are skipped and one child is removed from the circle. In which order will the children be removed?
Input
