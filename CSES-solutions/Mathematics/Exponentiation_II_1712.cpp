...
Your task is to efficiently calculate values abca^{b^c}abc modulo 109+710^9+7109+7.
Note that in this task we assume that 00=10^0=100=1.
Input
The first input line has an integer nnn: the number of calculations.
After this, there are nnn lines, each containing three integers aaa, bbb and ccc.
Output
Print each value abca^{b^c}abc modulo 109+710^9+7109+7.
Constraints
