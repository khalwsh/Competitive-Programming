...
A binomial coefficient (ab){a \choose b}(ba​) can be calculated using the formula a!b!(a−b)!\frac{a!}{b!(a-b)!}b!(a−b)!a!​. We assume that aaa and bbb are integers and 0≤b≤a0 \le b \le a0≤b≤a.
Input
...
Output
Print each binomial coefficient modulo 109+710^9+7109+7.
Constraints

1≤n≤1051 \le n \le 10^51≤n≤105
0≤b≤a≤1060 \le b \le a \le 10^60≤b≤a≤106
