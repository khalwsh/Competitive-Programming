...
Your task is to efficiently calculate values aba^bab modulo 109+710^9+7109+7.
...
After this, there are nnn lines, each containing two integers aaa and bbb.
Output
Print each value aba^bab modulo 109+710^9+7109+7.
Constraints
