...
Finally, there are mmm lines that describe the operations. Each line has two integers aaa and bbb: you reverse a substring from position aaa to position bbb.
Output
