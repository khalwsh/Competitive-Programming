...
Killing a monster takes sfsfsf time where sss is the monster's strength and fff is your skill factor (lower skill factor is better). After killing a monster, you get a new skill factor. What is the minimum total time in which you can win the game?
Input
...
1≤s1≤s2≤⋯≤sn≤1061 \le s_1 \le s_2 \le \dots \le s_n \le 10^61≤s1​≤s2​≤⋯≤sn​≤106
x≥f1≥f2≥⋯≥fn≥1x \ge f_1 \ge f_2 \ge \dots \ge f_n \ge 1x≥f1​≥f2​≥⋯≥fn​≥1
