struct PalindromicTree {
    ...
    // link (fail link the next smaller palindrome)
    // cnt (how many suffix palindrome that end at that position)
    // oc (how many palindrome in the entire string that match this palindrome)
    ...
    // Stores the node that has the palindromes suffixes end at each position
